...
comp=axiomcsv[c(340, 343, 345, 349, 351, 353),] #select parent plants from dataset
acomp=all.equal(comp[1,], comp[2,]) #find markers in which parents of same cultivar differ

t = strsplit(acomp[4], " ")[[1]][2] #parse string from acomp to get marker
substring(t, 2, nchar(t)-2) #more parsing
...
axiomdata_untouched[350,]
all.equal(axiomdata_untouched[350]
