...
#load up each quadrant and assign bins (sequenctially)
...
#     BEGINING OF PAIRWISE LG COMPARISON                                                                            ####
...
for(i in 1:nrow(chromo.character.counts)){
    strsplit(chromo.character.counts[i,1], " ")
}
...
write.csv(onebq1_comb, paste("pairwiseLGcomparisons/onebq1_comb","_",b,"_",auto.chromosome.assignment,".csv",sep=""), row.names = F)
