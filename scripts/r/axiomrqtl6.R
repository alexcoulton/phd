...
#########BEGIN RQTL ANALYSES###########
axiomdata = read.cross("csv", "./", "flipped_data2_pruned.csv", estimate.map=F) #NOTE THE THIRD ARGUMENT — CHANGE BETWEEN flipped_data2.csv AND flipped_data2_pruned.csv ACCORDINGLY
