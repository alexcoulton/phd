...
getaverageposition(1, q1genotypelist)
as.numeric(makehistlist(1, q1genotypelist, F))
...
makehistlist(1, q1genotypelist, T)
alexq1[1,]
alexq1[1,]==1
...
alexq1[,which(alexq1[1,]==LG.TO.ANALYSE)]
howmany=length(which(alexq1[1,]==LG.TO.ANALYSE)) #how many markers in the LG?
#make list of intervals for this particular LG
s1=seq(1,howmany,round(howmany/10))
...
setupglmdf=function(genotypelist, dataset, populationsize, temp){
    testdf=newdf(nrow = 1, ncol=3, c("rf","interval","temp"))
    counter=1
    for(i in 1:length(s2)){
        eventslist=countevents(LG.TO.ANALYSE, genotypelist, s2[[i]][1], s2[[i]][2], dataset)
...
s2
countevents(20, q1genotypelist, 41, 45, alexq1)

q1=setupglmdf(q1genotypelist, alexq1, popq1, 10)
q2=setupglmdf(q2genotypelist, alexq2, popq2, 26)
q3=setupglmdf(q3genotypelist, alexq3, popq3, 14)
q4=setupglmdf(q4genotypelist, alexq4, popq4, 28)

allg=rbind(q1,q2,q3,q4)
...
countevents(20, q1genotypelist, s2[[1]][1], s2[[1]][2], alexq1)




g1=setupglmdf(q1genotypelist, alexq1, popq1, 10)
g2=setupglmdf(q2genotypelist, alexq2, popq2, 26)
g3=setupglmdf(q3genotypelist, alexq3, popq3, 14)
g4=setupglmdf(q4genotypelist, alexq4, popq4, 28)
...
sum(countevents(20, q1genotypelist, 0, 25, alexq1))/popq1
sum(countevents(20, q2genotypelist, 0, 25, alexq2))/popq2
sum(countevents(20, q3genotypelist, 0, 25, alexq3))/popq3
sum(countevents(20, q4genotypelist, 0, 25, alexq4))/popq4

noq1.20=countevents(20, q1genotypelist, 0, 25, alexq1)
...
startbin=1
endbin=15
noq1.15=countevents(lg, q1genotypelist, startbin,endbin, alexq1)
noq2.15=countevents(lg, q2genotypelist, startbin,endbin, alexq2)
noq3.15=countevents(lg, q3genotypelist, startbin,endbin, alexq3)
noq4.15=countevents(lg, q4genotypelist, startbin,endbin, alexq4)
...
lgtomakehistlistfor=17
    ...
    blastfile$blast_per_filled=(replacena(replacena(blastfile$blast_per_filled)))
    ...
    q1hist=makehistlist(lgtomakehistlistfor, q1genotypelist, F)
    q2hist=makehistlist(lgtomakehistlistfor, q2genotypelist, F)
    q3hist=makehistlist(lgtomakehistlistfor, q3genotypelist, F)
    q4hist=makehistlist(lgtomakehistlistfor, q4genotypelist, F)
